...
export default function Sidebar({ type = "dashboard", items = [] }: any) {
  ...
  const navItems =
    type == "dashboard"
      ...
      : [
          { href: "/portal", label: "List", icon: Menu },
          ...items.map((item: any) => ({
            href: item.href,
            label: item.label,
            icon: House,
  ...
  const visibleItems = navItems.filter(
    (item) => !item.permission || has(item.permission as any),
  );
        ...
        <>
          ...
          <motion.aside
            ...
            style={{
              ...
              background:
                "color-mix(in srgb, var(--foreground) 96%, transparent)",
            }}
          >
            {/* Navigation */}
            <nav>
                ...
                <>
                  ...
                  <div className="flex items-center gap-3 px-2">
                    <div
                      ...
                      style={{
                        background:
                          "color-mix(in srgb, var(--accent) 20%, var(--foreground))",
                        color: "var(--accent)",
                      }}
                    >
      ...
      <Link
        ...
        style={
          isActive
            ? {
                background:
                  "color-mix(in srgb, var(--accent) 15%, var(--foreground))",
                color: "var(--accent)",
              }
            : undefined
        }
