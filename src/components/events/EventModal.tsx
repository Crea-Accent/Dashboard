...
function LocationAutocomplete({ value, onChange }: { value: string; onChange: (val: string) => void }) {
	...
	return <Input ref={inputRef} label="Location" value={value} onChange={(e) => onChange(e.target.value)} placeholder="Search for a location..." />;
}
	...
	return (
		...
		>
			<div className="space-y-4 pt-2">
				<Input label="Event Name" value={name} onChange={(e) => setName(e.target.value)} placeholder="E.g. Annual Company Retreat" />
				<div>
