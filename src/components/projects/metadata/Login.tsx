    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {value.map((login, index) => (
          <div
            key={login.id}
            className="rounded-3xl p-4 flex flex-col bg-(--accent)/10 border-2 border-(--accent)/70"
          >
            ...
            {editing === index ? (
              <div className="flex flex-col gap-3 flex-1">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateField(index, "username", e.target.value)
                  }
                />
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateField(index, "password", e.target.value)
                  }
                />

                <Toggle
                  checked={login.client}
                  onChange={(checked) => updateField(index, "client", checked)}
        ...
        {has("projects.write") && (
          <Button
            ...
            className="rounded-3xl p-4 min-h-55 flex flex-col items-center justify-center gap-2"
          >
            <Plus size={28} />
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Input
            label="Label"
            value={newLogin.label}
            onChange={(e) =>
              setNewLogin({ ...newLogin, label: e.target.value })
            }
          />
          ...
          <Input
            label="Link"
            value={newLogin.link}
            onChange={(e) => setNewLogin({ ...newLogin, link: e.target.value })}
          />
