		...
		<Modal
			...
			<div className='space-y-4'>
				<p className='text-sm text-(--text-muted)'>
					You are about to mark this task as completed. {requiresPicture ? 'A proof photo is required for this task.' : 'You can optionally attach a picture as proof of work.'}
				</p>
