              ...
              <table width="100%" border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" bgcolor="#F9F7F3" style={{ maxWidth: '800px', margin: '0 auto' }}>
                <tr>
                  <td align="center" bgcolor="#F9F7F3">
                    ...
                    <table width="100%" border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" bgcolor="#F9F7F3" style={{ maxWidth: '550px', margin: '0 auto' }}>
                      <tr>
                        <td align="center" bgcolor="#F9F7F3">
                          {event?.description ? (
                            ...
                            <>
                              <Text style={styles.text}>Wij nodigen u graag persoonlijk uit voor<br/>een exclusieve netwerk- en inspiratieavond in onze showroom.</Text>
                              <Text style={styles.text}>Tijdens deze avond delen we trends en inzichten in high-end interieurprojecten,<br/>van ontwerp tot uitvoering, en bieden we de mogelijkheid om te netwerken<br/>met andere bouwprofessionals.</Text>
                            </>
                          )}
                        </td>
                      </tr>
                    ...
                    <table width="100%" border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" bgcolor="#F9F7F3" style={{ maxWidth: '400px', margin: '0 auto' }}>
                      <tr>
                        ...
                        <td width="34%" align="center" valign="middle" bgcolor="#F9F7F3" style={{ padding: '0 20px' }}>
                          ...
                          <div style={styles.dateDayBox}>
                            {isValidDate ? String(dateObj.getDate()).padStart(2, '0') : ''}
                          </div>
                    ...
                    <table width="100%" border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" bgcolor="#F9F7F3" style={{ maxWidth: '800px', margin: '0 auto' }}>
                      <tr>
                        ...
                        <td width="45%" valign="middle" align="left" bgcolor="#F9F7F3">
                          ...
                          <table border={0} cellPadding={0} cellSpacing={0} role="presentation" style={{ fontSize: '15px', lineHeight: '1.8', color: '#111111', width: '100%' }}>
                            <tbody>
                              {event?.welcomeTime && (
                                <tr><td style={styles.tdLeft} bgcolor="#F9F7F3">{event.welcomeTime}</td><td style={styles.tdRight} bgcolor="#F9F7F3">ontvangst</td></tr>
                              )}
                              {event?.startTime && (
                                <tr><td style={styles.tdLeft} bgcolor="#F9F7F3">{event.startTime}</td><td style={styles.tdRight} bgcolor="#F9F7F3">welkomstwoord</td></tr>
                              )}
                              {event?.endTime && (
                                <tr><td style={styles.tdLeft} bgcolor="#F9F7F3">{event.endTime}</td><td style={styles.tdRight} bgcolor="#F9F7F3">einde</td></tr>
                              )}
                            </tbody>
                          </table>
                        </td>
                    ...
                    <table width="100%" border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" bgcolor="#F9F7F3" style={{ maxWidth: '550px', margin: '0 auto' }}>
                      <tr>
                        <td align="center" bgcolor="#F9F7F3">
                          <Text style={styles.text}>Het aantal plaatsen is beperkt.<br/>We reserveren graag een plekje voor u!</Text>
                          <Text style={styles.text}>Denk jij nog aan iemand die onze showroom ook zeker eens gezien moet hebben?<br/>Neem dan gerust 1 of 2 bouw-gerelateerde contacten mee!<br/>Gelieve ook hun aanwezigheid te bevestigen.</Text>
                          ...
                          <table border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" style={{ margin: '0 auto' }}>
                            <tr>
                              <td align="center" bgcolor="#899B73" style={{ borderRadius: '999px', padding: '16px 40px' }}>
                                <Link
                                  href={`${baseUrl}/invite/${event?.id}/${contact?.id}`}
                    ...
                    <table width="100%" border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" bgcolor="#F9F7F3" style={{ maxWidth: '550px', margin: '0 auto' }}>
                      <tr>
                        <td align="center" bgcolor="#F9F7F3">
                          <Text style={styles.text}>Wij voorzien een hapje en een drankje.<br/>Maak daarnaast kennis met andere interessante contacten uit de sector!</Text>
                    ...
                    <table width="100%" border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" bgcolor="#F9F7F3" style={{ maxWidth: '550px', margin: '0 auto' }}>
                      <tr>
                        <td align="center" bgcolor="#F9F7F3">
                          ...
                          <Text style={styles.text}>{event?.location || 'Er is voldoende parkeerplek op het Lodewijk De Vocht plein; dit is op 200m stappen van onze showroom.'}</Text>
                          
                          <Spacer height={20} />
                          
                          <table border={0} cellPadding={0} cellSpacing={0} role="presentation" align="center" style={{ margin: '0 auto' }}>
                            <tr>
                              <td align="center" bgcolor="#111111" style={{ borderRadius: '999px', padding: '14px 30px' }}>
                                <Link
