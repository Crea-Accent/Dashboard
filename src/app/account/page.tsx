...
export default function Page() {
  ...
  const [projectPromptEnabled, setProjectPromptEnabled] = useState<boolean>(
    session?.user?.preferences?.projectPrompts ?? true,
  );
  const [debugMode, setDebugMode] = useState<boolean>(
    session?.user?.preferences?.debugMode ?? false,
  );
