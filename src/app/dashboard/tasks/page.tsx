...
import { CheckCircle2, Circle, ClipboardList, Clock, Edit3, FolderOpen, Search } from 'lucide-react';
			...
			<motion.div className="space-y-6">
				...
				<div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3">
					...
					<div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto flex-wrap">
						{has('tasks.write') && (
							<div className="flex items-center bg-(--foreground) border border-(--border)/20 rounded-xl px-4 h-10.5 min-w-48 shadow-sm">
