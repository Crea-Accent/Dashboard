...
export default function InvitePage() {
  ...
  const [status, setStatus] = useState<"pending" | "confirmed" | "refused">(
    "pending",
  );
      ...
      <div className="max-w-xl w-full bg-white rounded-[24px] overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.03)]">
        ...
        <div className="bg-[#a4b795]/10 p-8 text-center border-b border-[#a4b795]/20">
          ...
          <p className="text-zinc-600 font-medium">
            Hallo {contact?.name}, u bent uitgenodigd!
          </p>
        </div>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${status === "confirmed" ? "border-[#a4b795]" : "border-zinc-300"}`}
                >
                  {status === "confirmed" && (
                    <div className="w-2.5 h-2.5 bg-[#a4b795] rounded-full" />
                  )}
                </div>
              ...
              >
                <div
                  className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${status === "refused" ? "border-red-400" : "border-zinc-300"}`}
                >
                  {status === "refused" && (
            ...
            <div className="space-y-4 pt-6 border-t border-zinc-100">
              ...
              {guests.length === 0 ? (
                <p className="text-zinc-500 text-sm">
                  U kunt maximaal 2 extra gasten meebrengen.
                </p>
              ) : (
                <div className="space-y-4">
                  {guests.map((guest, index) => (
                    <div
                      key={index}
                      className="bg-zinc-50 p-4 rounded-xl border border-zinc-200 relative group"
                    >
                      <button
          ...
          <div className="pt-6">
            <button
              ...
              disabled={
                ...
                status === "pending" ||
                (status === "confirmed" &&
                  guests.some((g) => !g.name.trim() || !g.company.trim()))
              }
