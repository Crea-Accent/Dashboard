        ...
        try {
          ...
          return {
            ...
            updatedAt:
              ...
              fs
                .statSync(
                  path.join(/*turbopackIgnore: true*/ basePath, folder.name),
                )
                .mtime.toISOString(),
            ...
            panels:
              solar?.recommended?.panelsCount ??
              solar?.maximum?.panelsCount ??
              null,

            yield:
              solar?.recommended?.yearlyEnergyDcKwh ??
              solar?.maximum?.yearlyEnergyDcKwh ??
              null,
